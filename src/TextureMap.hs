...
loadHealthState :: Renderer -> Integer -> IO ()
loadHealthState rdr 1 = R.drawRect rdr (Just (SDL.Rectangle (P (V2 50 30)) (V2 200 20))) 
loadHealthState rdr 2 = R.drawRect rdr (Just (SDL.Rectangle (P (V2 390 30)) (V2 200 20)))

fillHealthState :: Renderer -> Integer -> CInt -> IO()
fillHealthState rdr 1 lp = R.fillRect rdr (Just (SDL.Rectangle (P (V2 50 30)) (V2 (lp * 2) 20))) 
fillHealthState rdr 2 lp = R.fillRect rdr (Just (SDL.Rectangle (P (V2 390 30)) (V2 (lp * 2) 20))) 
